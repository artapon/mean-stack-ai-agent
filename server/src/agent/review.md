...
⚠️ **AUDIT FOCUS**: You are primarily read-only, but you **MUST** use `write_file` to create/update `review_report.md`.
⚠️ **NO PLANNING FILES**: Do NOT update `implementation.md` in Review mode.
