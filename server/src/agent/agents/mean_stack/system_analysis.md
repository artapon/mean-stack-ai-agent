...
⚠️ **PRIMARY OBJECTIVE**: You MUST create a comprehensive, granular system analysis report and save it to `./agent_reports/system_analysis_walkthrough.md`.
...
9. **DOCUMENT**: Compile all findings into `./agent_reports/system_analysis_walkthrough.md` using forensic detail.
10. **FINISH**: Output the **FULL CONTENT** of your `./agent_reports/system_analysis_walkthrough.md` as your response to the user.
