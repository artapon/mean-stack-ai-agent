...
⚠️ **PRIMARY OBJECTIVE**: You MUST create a comprehensive, granular UI/UX system analysis report and save it to `./agent_reports/system_analysis_walkthrough.md`.
...
7. **DOCUMENT**: Compile all findings into `./agent_reports/system_analysis_walkthrough.md` using forensic-level detail.
8. **FINISH**: Output the **FULL CONTENT** of your `./agent_reports/system_analysis_walkthrough.md` as your response to the user.

---

## 🟢 MANDATORY: SYSTEM ANALYSIS REPORT (./agent_reports/system_analysis_walkthrough.md)
...
## Fast Mode Adherence
In Fast Mode, skip internal reasoning in your summary, but keep the `./agent_reports/system_analysis_walkthrough.md` at maximum granular depth.
